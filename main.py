...
# 'syseeprom' subcommand ("show platfoPSUrm syseeprom")
@platform.command()
@click.option('--verbose', is_flag=True, help="Enable verbose output")
...
RESULT_FAILED = " Test Result: ------[\033[7;31mFAILED\033[0m]\n"

RESULT_PASS   = " Test Result: ------[\033[0;32mPASS\033[0m]\n"
...
def ssd_firmwareinfo(device):
    ...
    if proc.returncode > 0:
        ...
        click.echo(testname + RESULT_FAILED)
        return
    else:
        for line in output:
    ...
    if (checkin == 1):
        click.echo(testname + RESULT_PASS)
    else:
...
def ssd_badblock(device):
    ...
    if(checkin == 1):
        ...
        click.echo("Can't get 'Later_Bad_Block' attributes")
        click.echo(testname + RESULT_FAILED)
